...
public class FluidInit {
  public static final DeferredRegister<Fluid> REGISTRY = DeferredRegister.create(BuiltInRegistries.FLUID, VoidsentFlameMod.MODID);
	public static final DeferredHolder<Fluid, FlowingFluid> VOID_FLUID = REGISTRY.register("void_fluid", () -> new VoidFluid.Source());
	public static final DeferredHolder<Fluid, FlowingFluid> FLOWING_VOID_FLUID = REGISTRY.register("flowing_void_fluid", () -> new VoidFluid.Flowing());
