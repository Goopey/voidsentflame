...
public class VoidSeaLayerBlockEntityRenderer implements BlockEntityRenderer<VoidSeaLayerBlockEntity> {
  ...
  public VoidSeaLayerBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
    ...
    //   RenderType.CompositeState.builder().setLightmapState(LightmapStateShard.LIGHTMAP).setTextureState(RenderStateShard.BLOCK_SHEET_MIPPED).createCompositeState(true)); 
  }
  ...
  @Override
  public AABB getRenderBoundingBox(@Nonnull VoidSeaLayerBlockEntity blockEntity) {
    return new AABB(
